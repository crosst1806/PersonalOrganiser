...
public class ActivityCrudDialog extends DialogFragment
    ...
    public ActivityCrudDialog() {
    }

    public static ActivityCrudDialog newInstance(int mode, Activity activity) {

        ActivityCrudDialog frag = new ActivityCrudDialog();
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        final View view = inflater.inflate(R.layout.crud_form_activity, null);
        ...
        UtilityHelper.selectSpinnerIndex(prioritySpinner, priorityAdapter,
                                                Integer.valueOf(activity.getPriority()));
        ...
        medianMinutesView.setText(
                model.formatMedianMinutes(activity.getMedianMinutes()));
