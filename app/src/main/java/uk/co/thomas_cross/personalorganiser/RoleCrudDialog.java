...
public class RoleCrudDialog extends DialogFragment implements AdapterView.OnItemSelectedListener {
    ...
    public RoleCrudDialog() {
    }

    public static RoleCrudDialog newInstance(int mode, Role role) {

        RoleCrudDialog frag = new RoleCrudDialog();
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        final View view = inflater.inflate(R.layout.crud_form_role, null);
        ...
        deleteForeverButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (role.getDatabaseRecordNo() != 0) {
                    POModel poModel1 = POModel.getInstance(getContext());
