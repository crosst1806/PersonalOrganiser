...
public class LocationCrudDialogFragment extends DialogFragment
    ...
    public LocationCrudDialogFragment() {
    }

    public static LocationCrudDialogFragment newInstance(int mode, Location location) {

        LocationCrudDialogFragment frag = new LocationCrudDialogFragment();
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        final View view = inflater.inflate(R.layout.location_crud_form, null);
