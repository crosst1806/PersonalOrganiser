...
public class ToDoCrudDialogFragment extends DialogFragment
    ...
    public void onClick(View v) {
        ...
        if (v == targetDateEditView) {
            ...
            Log.i(TAG, "Old date is " + oldDateX);
            try {
    ...
    public interface ToDoCrudDialogListener {
    ...
    ToDoCrudDialogListener mListener;

    public ToDoCrudDialogFragment() {
    }

    public static ToDoCrudDialogFragment newInstance(int mode, ToDo toDo) {

        ToDoCrudDialogFragment frag = new ToDoCrudDialogFragment();
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        poModel = new POModel(this.getContext());
        ...
        final View view = inflater.inflate(R.layout.todo_crud_form, null);
        ...
        UtilityHelper.selectSpinnerIndex(locationSpinner, locationAdapter, locations, location);
        ...
        UtilityHelper.selectSpinnerIndex(prioritySpinner, priorityAdapter,
                priorities, new Integer(toDo.getPriority()));
        ...
        UtilityHelper.selectSpinnerIndex(dataSensitivitySpinner, dataSensitivityAdapter,
                dataSensitivitys, dataSensitivity);
        ...
        deleteForeverButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                getDialog().dismiss();
                mListener.onDialogPositiveClick(toDo);
            }
        });
        ...
        updateButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                prioritySpinner.setAdapter(priorityAdapter);
                UtilityHelper.selectSpinnerIndex(prioritySpinner, priorityAdapter,
                        priorities, Integer.valueOf(toDo.getPriority()));
    ...
    public void onAttach(Context context) {
        ...
        try {
            ...
            mListener = (ToDoCrudDialogListener) context;
        } catch (ClassCastException e) {
            // The activity doesn't implement the interface, throw exception
            throw new ClassCastException(context.toString()
                    + " must implement ToDoCrudDialogListener");
        }
    }

    private void initialiseDatePicker() {

        targetDatePickerDialog = new DatePickerDialog(
