...
public class PlannedActivity extends DataSensitiveEntity implements Serializable {
    ...
    public static final int SINGLE_INSTANCE_ADDED_TO_SCHEDULE = 0;
    public static final int ACTIVITY_ITERATION_ENABLED = 1;
    ...
    public void setMedianMinutes(int medianMinutes){ this.medianMinutes = medianMinutes; }

    public int getMedianMinutes(){ return this.medianMinutes; }

    public void setPriority(int priority){ this.priority = priority;}

    public int getPriority(){ return  this.priority; }

    public void setGeneratorType(int generatorType){ this.generatorType = generatorType; }
    ...
    public int getGeneratorId(){ return this.generatorId; }
