...
public class ActivityActivity extends AppCompatActivity
    ...
    private void showActivityCrudDialog(int mode, Activity activity) {
        FragmentManager fm = getSupportFragmentManager();
        ActivityCrudDialogFragment dialogFragment = ActivityCrudDialogFragment.newInstance(mode,activity);
